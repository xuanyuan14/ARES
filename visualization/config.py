...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--visual_q_num', type=int, default=1,
                        help='visual query number')
    parser.add_argument('--visual_d_num', type=int, default=5,
                        help='visual document number')
    parser.add_argument('--model_name', type=str, default='ARES_simple',
                        choices=['ARES_simple', 'ARES_hardest', 'BERT', 'PROP_msmarco'],
                        help='the model name')
    parser.add_argument('--model_type', type=str, default='ARES',
                        choices=['ARES', 'PROP', 'BERT'],
                        help='the model type')
